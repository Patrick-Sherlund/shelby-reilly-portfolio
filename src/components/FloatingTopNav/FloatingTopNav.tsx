...
export default function FloatingTopNav() {
  ...
  // close the desktop mini-panel on outside click (desktop only)
  ...
  return (
    <>
          ...
          <>
            ...
            <IconButton size="small" sx={{ ml: 0, mr: 2 }} onClick={toggleProfiles}>
              <KeyboardArrowDownIcon
                fontSize="small"
                sx={{ transform: openProfiles ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform .2s' }}
              />
            </IconButton>
      ...
      >
        <Box role="navigation" sx={{ height: '100%', display: 'flex', flexDirection: 'column', pb: 'env(safe-area-inset-bottom)' }}>
          <DrawerHeader>
