...
export const HeroMetaList = styled('dl')(({ theme }) => ({
  margin: 0, padding: 0, display: 'grid', gridTemplateColumns: 'auto 1fr', rowGap: 18, columnGap: 24, textAlign: 'left', color: theme.palette.text.primary
}))
...
export const KPIChip = styled('div')(({ theme }) => ({
  ...
  display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 2, transition: 'transform .2s, box-shadow .2s, background .2s', color: theme.palette.text.primary,
  '&:hover': {
...
export const KPIValue = styled('div')(({ theme }) => ({ fontWeight: 900, fontSize: 22, lineHeight: 1.1, color: theme.palette.text.primary }))
export const KPILabel = styled('div')(({ theme }) => ({
  fontSize: 12, fontWeight: 800, letterSpacing: .6, textTransform: 'uppercase',
  color: theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.75)' : 'rgba(0,0,0,0.75)'
}))
export const HeroProblemTitle = styled('h3')(({ theme }) => ({ margin: '12px 0 6px 0', fontSize: 18, lineHeight: 1.25, fontWeight: 900, color: theme.palette.text.primary }))
...
export const SectionTitle = styled('h2')(({ theme }) => ({
  margin: '0 0 28px 0', fontFamily: "'Futura LT', 'Futura', sans-serif", fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 900, color: theme.palette.text.primary, lineHeight: 1.2
}))
...
export const StatNumber = styled('div')(({ theme }) => ({ fontSize: 'clamp(36px, 6vw, 52px)', fontWeight: 900, color: theme.palette.text.primary, lineHeight: 1, marginBottom: 8 }))
