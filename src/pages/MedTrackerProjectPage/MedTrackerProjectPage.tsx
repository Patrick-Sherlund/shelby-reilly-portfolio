        ...
        return (
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                    ...
                    <Box sx={{ fontWeight: 900, fontSize: 11, letterSpacing: 0.8, textTransform: 'uppercase', color: theme.palette.text.primary }}>
                        {label}
                    </Box>
                </Box>
                        ...
                        <HeroContent>
                            ...
                            <Box sx={{ marginTop: '3rem' }}>
                                <Typography sx={{ textAlign: "center" }}>
                                    Designed mobile app to Streamline medical inventory process from 18 steps to 5 steps,
                                </Typography>
                                ...
                                <Box sx={{ display: 'grid', gap: 8 }}>
                                    ...
                                    >
                                        ...
                                        >
                                            <Box>
                                                <TextBlock as="div">
                                                    We embedded with medical logistics and engineering teams to observe real workflows from intake to disposition.
                                                </TextBlock>

                                                <div className="bullet-h" style={{ marginTop: 16 }}>What we did</div>
                                                <ListItem>Stakeholder & user interviews across 3 key roles</ListItem>
                                                ...
                                                <ListItem>No standardized in-processing or disposition workflow</ListItem>
                                                <ListItem>18+ manual steps per med box, paper reconciliation</ListItem>
                                                ...
                                                <TextBlock as="div" style={{ marginTop: 4 }}>
                                                    Surfaced systemic bottlenecks that informed the redesign priorities and readiness metrics.
                                                </TextBlock>
                                            </Box>
                                    ...
                                    >
                                        ...
                                        <ListItem>Affinity board clustering themes: redundancy, ownership, data fragmentation</ListItem>
                                        <ListItem>Workshop outcomes aligning Eng + Ops on opportunities</ListItem>

                                        <div className="bullet-h" style={{ marginTop: 16 }}>Impact</div>
                                        <TextBlock as="div" style={{ marginTop: 4 }}>
                                            Created a shared understanding of how things actually work — a single reference that grounded the redesign phase.
                                        </TextBlock>
                                    ...
                                    >
                                        ...
                                        >
                                            <Box>
                                                ...
                                                <div className="bullet-h" style={{ marginTop: 16 }}>Top prioritized problems to solve</div>
